import openpyxl
workbook = openpyxl.load_workbook("D:/PMC-analysis-using-LLM-main/results/main_variable_scores_&_PMC_index.xlsx", data_only=True)
...
for i in dict_main_variables.keys():
    ...
    wb.save(
        "D:/PMC-analysis-using-LLM-main/results/PMC Surface/{}.xlsx".format(name))
